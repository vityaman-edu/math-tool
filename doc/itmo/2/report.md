...
|         |                         |
| ------- | ----------------------- |
| Автор   | Смирнов Виктор Игоревич |
| Группа  | P32131                  |
| Вариант | 17                      |

## Введение

Цель работы: изучить численные методы решения
нелинейных уравнений и их систем, 
найти корни заданного нелинейного
уравнения/системы нелинейных уравнений, вы-
полнить программную реализацию методов.
